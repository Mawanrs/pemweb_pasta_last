...
<body>
    ...
    <section class="site-hero site-hero-innerpage overlay" data-stellar-background-ratio="0.5"
        style="background-image: url(frontend/assets/img/header2.jpg);">
        <div class="container">
            ...
            <div class="row ">
                <div class="col-md-4">
                    <div class="post-entry">
                        <img src="frontend/assets/img/indoor.jpg" alt="Image placeholder" class="img-fluid">
                        <div class="body-text">
                ...
                <div class="col-md-4">
                    <div class="post-entry">
                        <img src="frontend/assets/img/outdoor.jpg" alt="Image placeholder" class="img-fluid">
                        <div class="body-text">
                ...
                <div class="col-md-4">
                    <div class="post-entry">
                        <img src="frontend/assets/img/vip.jpg" alt="Image placeholder" class="img-fluid">
                        <div class="body-text">
    ...
    <section class="section-cover" data-stellar-background-ratio="0.5"
        style="background-image: url(frontend/assets/img/about1.jpg);">
        <div class="container">
