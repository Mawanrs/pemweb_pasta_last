    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.update", [$customer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $customer->description) !!}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="faximile">{{ trans('cruds.customer.fields.faximile') }}</label>
                <input class="form-control {{ $errors->has('faximile') ? 'is-invalid' : '' }}" type="text" name="faximile" id="faximile" value="{{ old('faximile', $customer->faximile) }}" required>
                @if($errors->has('faximile'))
                    <div class="invalid-feedback">
                        {{ $errors->first('faximile') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.customer.fields.faximile_helper') }}</span>
            </div>
            <div class="form-group">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.customers.storeCKEditorImages') }}', true);
