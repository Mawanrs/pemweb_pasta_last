        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover datatable datatable-Table">
                <thead>
                    <tr>
                        <th width="10"></th>
                        <th>{{ trans('cruds.table.fields.id') }}</th>
                        <th>{{ trans('cruds.table.fields.place') }}</th>
                        <th>{{ trans('cruds.table.fields.name') }}</th>
                        <th>{{ trans('cruds.table.fields.start') }}</th>
                        <th>{{ trans('cruds.table.fields.finish') }}</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($tables as $key => $table)
                        <tr data-entry-id="{{ $table->id }}">
                            <td></td>
                            <td>{{ $table->id ?? '' }}</td>
                            <td>{{ App\Models\Table::PLACE_SELECT[$table->place] ?? '' }}</td>
                            <td>{{ $table->name ?? '' }}</td>
                            <td>{{ $table->start ?? '' }}</td>
                            <td>{{ $table->finish ?? '' }}</td>
                            <td>
